...
from talibrt._ta_lib cimport TA_RetCode, TA_FuncUnstId
...
cpdef _ta_check_success(str function_name, TA_RetCode ret_code):
    if ret_code == 0:
        ...
        #description = 'More data is required (TA_NEED_MORE_DATA)'
        return False
    elif ret_code == 18:
        description = 'I/O error (TA_IO_FAILED)'
    elif ret_code == 5000:
...
for i, name in enumerate([
            ...
            'HT_TRENDMODE', 'IMI', 'KAMA', 'MAMA', 'MFI', 'MINUS_DI', 'MINUS_DM',
