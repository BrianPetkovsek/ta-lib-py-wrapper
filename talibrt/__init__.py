...
# If pandas is available, wrap talibrt functions so that they support
# pandas.Series input
try:
...
for func_name in __TA_FUNCTION_NAMES__:
    ...
    wrapped_func = (getattr(func, func_name + "_State"))
    setattr(func, func_name + "_State", wrapped_func)
    globals()[func_name + "_State"] = wrapped_func

    wrapped_func = (getattr(func, func_name + "_StateInit"))
    setattr(func, func_name + "_StateInit", wrapped_func)
    globals()[func_name + "_StateInit"] = wrapped_func

    wrapped_func = (getattr(func, func_name + "_StateFree"))
    setattr(func, func_name + "_StateFree", wrapped_func)
    globals()[func_name + "_StateFree"] = wrapped_func

    wrapped_func = (getattr(func, func_name + "_StateSave"))
    setattr(func, func_name + "_StateSave", wrapped_func)
    globals()[func_name + "_StateSave"] = wrapped_func

    wrapped_func = (getattr(func, func_name + "_StateLoad"))
    setattr(func, func_name + "_StateLoad", wrapped_func)
    globals()[func_name + "_StateLoad"] = wrapped_func

    wrapped_func = _pandas_wrapper(getattr(func, func_name + "_BatchState"))
    setattr(func, func_name, wrapped_func)
...
# or talibrt.abstract. Here, we handle initializing and shutting down the
