...
class Function(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        # allow calling with same signature as talibrt.func module functions
        args = list(args)
        input_arrays = {}
...
cdef __ta_initNewState(lib.TA_ParamHolder *holder):
    retCode = lib.TA_InitNewState(holder)
    _ta_check_success('TA_InitNewState', retCode)
