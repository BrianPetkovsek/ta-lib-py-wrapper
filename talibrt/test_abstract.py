...
import talibrt
from talibrt import func
from talibrt import abstract
from talibrt.test_data import ford_2012, assert_np_arrays_equal, assert_np_arrays_not_equal
...
def test_info():
    ...
    stochrsi.parameters = {'fastd_matype': talibrt.MA_Type.EMA}
    expected = {
...
def test_parameters():
    ...
    stoch.parameters = {'slowd_matype': talibrt.MA_Type.T3}
    expected['slowd_matype'] = 8
    assert_equals(expected, stoch.parameters)

    stoch.parameters = {
        'slowk_matype': talibrt.MA_Type.WMA,
        'slowd_matype': talibrt.MA_Type.EMA,
        }
